...
(function ($) { "use strict";
	...
	// 	if (name.length == 0) {
	// 		var error = true;
	// 		$('#name').css("border-color", "#182848");
	// 	} else {
	// 		$('#name').css("border-color", "#666");
	// 	}
	// 	if (email.length == 0 || email.indexOf('@') == '-1') {
	// 		var error = true;
	// 		$('#email').css("border-color", "#182848");
	// 	} else {
	// 		$('#email').css("border-color", "#666");
	// 	}
	// 	if (subject.length == 0) {
	// 		var error = true;
	// 		$('#subject').css("border-color", "#182848");
	// 	} else {
	// 		$('#subject').css("border-color", "#666");
	// 	}
	// 	if (message.length == 0) {
	// 		var error = true;
	// 		$('#message').css("border-color", "#182848");
	// 	} else {
	...
	// 		$.post("https://formspree.io/cody@codywilson.co", $("#contact-form").serialize(), function (result) {
...
function initialize() {
    ...
    var style = [
    	{"stylers": [{"hue": "#f7eba0"},{"visibility": "on"},{"invert_lightness": true},{"saturation": 40},{"lightness": 10}]}
	];
